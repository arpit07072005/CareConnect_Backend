...
import { caregiverdashboard, caregiverrating, getAllCareGivers, registerCareGiver } from "../controllers/careGiver.controller.js";
...
import { clientdashboard, clientrating, getAllClient, userDetails } from "../controllers/client.controllers.js";
...
router.route("/clientrating").post(clientrating)
router.route("/caregiverrating").post(caregiverrating)
